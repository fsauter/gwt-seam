...
public class GWTToSeamAdapter {
   ...
   private final Map<String, Method> METHOD_CACHE = new HashMap<String, Method>();
    ...
    */
   public ReturnedObject callWebRemoteMethod(String serviceIntfName, String methodName, Class<?>[] paramTypes, Object[] args)
    throws InvocationTargetException, IllegalAccessException, SecurityException
   {
